...
static uint32_t KEY_CLK[KEYn] = {WKUP_GPIO_CLK, KEY1_GPIO_CLK, KEY2_GPIO_CLK, KEY3_GPIO_CLK};
static GPIO_TypeDef * KEY_PORT[KEYn] = {WKUP_GPIO_PORT, KEY1_GPIO_PORT, KEY2_GPIO_PORT, KEY3_GPIO_PORT};
static uint16_t KEY_PIN[KEYn] = {WKUP_GPIO_PIN, KEY1_GPIO_PIN, KEY2_GPIO_PIN, KEY3_GPIO_PIN};
...
static uint8_t KEY_NVIC_IRQChannel[KEYn] = {EXTI0_IRQn,EXTI4_IRQn, EXTI3_IRQn};
