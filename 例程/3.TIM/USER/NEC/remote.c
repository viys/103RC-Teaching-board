...
void Remote_Event(void)
{
	...
	if((remote_num=Remote_Scan()) != 0)
	{
		switch (remote_num)
        {
			case REMOTE_0:
        		break;
        	case REMOTE_1:LED_State_Config(LED1,ON);
        		break;    
			case REMOTE_2:LED_State_Config(LED2,ON);
        		break;    
			case REMOTE_3:LED_State_Config(LED3,ON);
        		break;    
			case REMOTE_4:LED_State_Config(LED1,OFF);
        		break;    
			case REMOTE_5:LED_State_Config(LED2,OFF);
        		break;    
			case REMOTE_6:LED_State_Config(LED3,OFF);
        		break;    
			case REMOTE_7:LED_State_Config(LED1,TOGGLE);
        		break;    
			case REMOTE_8:LED_State_Config(LED2,TOGGLE);
        		break;    
			case REMOTE_9:LED_State_Config(LED3,TOGGLE);
        		break;
			case REMOTE_X:
        		break;
				case REMOTE_J:
