...
#define KEY1_EXTI_GPIO_PIN	GPIO_PinSource4
...
#define KEY3_GPIO_Mode		GPIO_Mode_IN_FLOATING
#define KEY3_EXTI_GPIO_PORT	GPIO_PortSourceGPIOA
#define KEY3_EXTI_GPIO_PIN	GPIO_PinSource6
